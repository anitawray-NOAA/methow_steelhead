...
gds_genoReader <- GdsGenotypeReader("gds", autosomeCode=1:27)
...
mort_2_day_GWAS<-assocTestSingle(gds_genos_iterator, null.model = mort_2_day_null_mod,
                                  test="Score") 
manhattanPlot(mort_2_day_GWAS$Score.pval, mort_2_day_GWAS$chr, signif = (0.05/60747), ylim = c(0,8))
